              ...
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-block-col" >
                <div class="tm-bg-primary-dark tm-block tm-block-products">
                  <div class="tm-product-table-container">
                    <table class="table table-hover tm-table-large tm-product-table" id="mytable" >
                      <thead>
                        <tr>
                  ...
                  ?>
                        ...
                        <th scope="row"><input type="checkbox" /></th>
                            ...
                            <td>
                            <img src="<?php echo $produit['image']; ?>" class="thumb-image"  >
                    </td>
                          ...
                          <form method="POST" action="modifierProduit.php">
                              <input type="submit" name="Modifier" value="Modifier" class="btn btn-primary btn-dark sm-12" >
